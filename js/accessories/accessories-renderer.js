...
<div class="item-card" id="%id%">
    ...
    <div class="buttons-container">
        <button class="small-btn btn-dark cart-btn" id="%id%">
            <span class="text-t3">Add to cart</span>
            <svg class="plus" width="14" height="15" viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg">
